...
/*   Updated: 2025/05/14 14:39:14 by kipouliq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class PmergeMe
{
    ...
    public:
        ...
        void                                 insertMain(std::vector<t_vec_pair> & main, std::vector<t_vec_pair>::iterator begin, std::vector<t_vec_pair>::iterator end, std::vector<t_vec_pair>::iterator to_insert);
